  ...
  try {
    window.Capacitor.Plugins.App.addListener('appStateChange', function(state) {
      if (state && state.isActive) {
        ...
        if (typeof resubscribeDispatchRealtime === 'function') {
          try { resubscribeDispatchRealtime(); } catch (e) {}
        }
      }
    });
