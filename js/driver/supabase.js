...
function supaUpdateRide(id,d){var o={};if(d.status!==undefined)o.status=d.status;if(d.driverId!==undefined)o.driver_id=d.driverId;if(d.picked_up_at!==undefined)o.picked_up_at=d.picked_up_at;if(d.completed_at!==undefined)o.completed_at=d.completed_at;if(d.driver_eta_secs!==undefined)o.driver_eta_secs=d.driver_eta_secs;if(d.driver_eta_updated_at!==undefined)o.driver_eta_updated_at=d.driver_eta_updated_at;supaFetch('PATCH','rides','?id=eq.'+encodeURIComponent(id),o)}
